...
extern "C" int nblink_packet_parse(struct ofpbuf * pktin,  struct ofl_match * pktout, struct protocols_std * pkt_proto)
{
    ...
    while (proto!= NULL)
    {
        /* Getting first field of the protocol  */
			...
			/*Modificacion UAH*/
			else if (protocol_Name.compare("arppath") == 0 && pkt_proto->arppath == NULL)
			{
				pkt_proto->arppath = (struct arp_path_header *) ((uint8_t*) pktin->data + proto->Position);
				PDMLReader->GetPDMLField(proto->Name, (char*) "op", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_OP);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sHwAddr", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SHA);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sIPAddr", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SPA);
				PDMLReader->GetPDMLField(proto->Name, (char*) "dHwAddr", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_THA);
				PDMLReader->GetPDMLField(proto->Name, (char*) "dIPAddr", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_TPA);

				PDMLReader->GetPDMLField(proto->Name, (char*) "sw1", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW1);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw2", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW2);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw3", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW3);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw4", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW4);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw5", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW5);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw6", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW6);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw7", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW7);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw8", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW8);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw9", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW9);
				PDMLReader->GetPDMLField(proto->Name, (char*) "sw10", proto->FirstField, &field);
				nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_ARPPATH_SW10);
			}
			else if (protocol_Name.compare("arppath_repair") == 0 && pkt_proto->arppath_repair == NULL)
			{
				pkt_proto->arppath_repair = (struct arppath_repair_header *) ((uint8_t*) pktin->data + proto->Position);
				PDMLReader->GetPDMLField(proto->Name, (char*) "op", proto->FirstField, &field);
            ...
            if (protocol_Name.compare("path") == 0 && pkt_proto->path == NULL)
            {
				pkt_proto->path = (struct path_header *) ((uint8_t*) pktin->data + proto->Position);
                PDMLReader->GetPDMLField(proto->Name, (char*) "sport", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_TCP_SRC);
                PDMLReader->GetPDMLField(proto->Name, (char*) "dport", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_TCP_DST);
				PDMLReader->GetPDMLField(proto->Name, (char*) "op", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_OP); 
                PDMLReader->GetPDMLField(proto->Name, (char*) "MacDst", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_MAC_DST); 
				PDMLReader->GetPDMLField(proto->Name, (char*) "id_dp", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_ID_SWITCH); 
				PDMLReader->GetPDMLField(proto->Name, (char*) "secuence", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_SECUENCE);
				PDMLReader->GetPDMLField(proto->Name, (char*) "contador", proto->FirstField, &field);
                nblink_extract_proto_fields(pktin, field, pktout, OXM_OF_PATH_SALTOS); 		
            }
